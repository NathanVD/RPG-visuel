...
// VARIABLES {
    ...
    //items
    let item1 = new Item("objet","Potion",0.33,"./public/img/items/potion.gif");
    let item2 = new Item("objet","Élixir de force",0.2,"./public/img/items/elixir.gif");
...
let choseItem = () => {
    return new Promise( resolve => {
        ...
        menuHeader.innerHTML = "Objets";
        let cancelItem = document.createElement("input");
        cancelItem.setAttribute("type","image");
        cancelItem.setAttribute("src","./public/img/lowercase-x.gif");
        cancelItem.setAttribute("id","cancel");
        cancelItem.addEventListener('click',() => {menu.remove();resolve(0)});
        menuHeader.appendChild(cancelItem);
